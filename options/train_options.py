...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.train.add_argument('--lr', type=float, default=0.001, help='initial learning rate for adam')
        ...
        self.train.add_argument('--lr_policy', type=str, default=None, help='learning rate policy: lambda|step|plateau')
        self.train.add_argument('--lr_decay_iters', type=int, default=20, help='multiply by a gamma every lr_decay_iters iterations')
